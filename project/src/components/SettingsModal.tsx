...
export default function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  ...
  const handleDownloadResume = () => {
    ...
    const resumeUrl = 'http://localhost:5000/resume.pdf';
    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-8">
          ...
          <div>
            <div>
              <h2 className="text-lg font-semibold mb-4 text-black dark:text-white">Accent Color</h2>
          ...
          <div>
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Get a copy of your professional resume in PDF format</p>
              </div>
              <button
